      ...
      <div class="flex space-x-4">
        <div class="relative flex-auto">
          <form
            ...
            "
          >
            <Search class="pointer-events-none absolute left-2 top-2 opacity-20" />
            <input
              type="search"
              class="w-full max-w-xl rounded border border-slate-400 bg-slate-50 p-2 pl-10 outline-none"
              placeholder="Search"
            >
