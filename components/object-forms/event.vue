<template>
  <div>
    <base-loader v-if="loading.getting || loading.gettingInvitees" />
    <Form v-else @submit="submitForm()">
      <div class="space-y-4">
        <form-input v-model="title" label="Event title" :error="errors.title" />
        <form-text v-model="description" label="Event description" :error="errors.description" />
        ...
        <div class="grid grid-cols-2 gap-4">
          <form-select v-model="duration_hours" label="Duration" :error="errors.duration_hours">
          ...
          <div>
            <form-input
              ...
              :error="errors.url"
            />
            <form-input v-else v-model="venue" label="Venue" :error="errors.venue" />
          </div>
