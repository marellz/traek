<template>
  <div class="rounded-xl border border-slate-300 p-4" ref="card" :class="[statusColor[status]]">
    <div class="flex space-x-3">
      <div
        class="rounded-lg bg-primary/20 p-4 self-start"
      ...
      <div class="flex-auto" :class="{'space-y-2': showMore}">
          ...
          <div class="flex items-center space-x-2">
            ...
            <div class="ml-auto flex space-x-2">
              <base-action @click="toggleShowMore">
                <ChevronDown class="transform rotate-0 ease-in-out transition" :class="{'rotate-180': showMore}" />
              </base-action>
        ...
        <div v-show="showMore" class="flex space-x-2">
          ...
          <template v-if="loading.gettingInvitees">
            <base-loader class="py-0"></base-loader>
          </template>
          <div v-else>
