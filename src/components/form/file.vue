    ...
    <label class="block" :for="id">
      ...
      <div
        ...
        <div>
          ...
          <template v-else>
            <h1 class="font-medium font-secondary text-2xl text-center md:text-left">
              Add a file
            </h1>
            <p class="text-center md:text-left">
              Upload a file you wish to upload
            </p>
            <ul class="mt-6 list-disc pl-5 text-gray-700 text-xs md:text-sm">
              <li>Accepted file types: {{ acceptedFormats[accepted] }}</li>
...
type AcceptedFormats = '*' | 'documents/*' | 'image/*'
...
// todo: populate these types
const acceptedFormats: Record<AcceptedFormats, string> = {
  '*': 'PDF, DOCX, JPG, PNG',
  'documents/*': "PDF, DOCX",
  'image/*': 'JPG, JPEG, PNG'
}
