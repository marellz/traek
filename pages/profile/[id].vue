<template>
  ...
  <layout-container class="m-10">
    <div>
      <Form @submit="submit()">
        <div class="space-y-4">
          <form-input v-model="name" label="Name" required :error="errors.name" />
          <form-input
            v-model="email"
            type="email"
            label="Email"
            ...
            :error="errors.email"
          />
          <form-input v-model="username" label="Username" required :error="errors.username" />
          <form-input v-model="phone" label="Phone number" :error="errors.phone" />
          <base-button>
